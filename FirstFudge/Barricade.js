...
(function (SpaceInvaders) {
    var f = FudgeCore;
    class Barricade extends f.Node {
        constructor(_pos) {
            ...
            for (let iStripe = 0; iStripe < Barricade.stripeCount; ++iStripe) {
                ...
                let pos = new f.Vector2((iStripe - (Barricade.stripeCount - 1) / 2) * width, Barricade.stripeYOffsets[iStripe] / 13);
                let scale = new f.Vector2(width, Barricade.stripeHeights[iStripe] / 13);
